...
const food_by_id_url = "$base_url/food/";
const food_by_category_url = "$base_url/food/by-category/";
const popular_meals_url = "$base_url/food/popular";
const food_category_list_url = "$base_url/food/category/list";
const food_list_url = "$base_url/food/list";

const search_food_url = "$base_url/food/search?query=";
